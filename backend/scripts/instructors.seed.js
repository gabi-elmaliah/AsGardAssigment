    ...
    const instructors = [
      {
        ...
        availability: [
          { day: 2, startMinutes: 960, endMinutes: 1200 }, 
          { day: 5, startMinutes: 960, endMinutes: 1200 }  
        ]
      },
      {
        name: "Yoni",
        ...
        availability: [
          ...
          { day: 5, startMinutes: 480, endMinutes: 900 }  
        ]
      },
      {
        name: "Jony",
        skills: ["freestyle", "breaststroke", "butterfly", "backstroke"],
        availability: [
          { day: 1, startMinutes: 600, endMinutes: 1140 }, 
          { day: 3, startMinutes: 600, endMinutes: 1140 }, 
          { day: 5, startMinutes: 600, endMinutes: 1140 }  
        ]
      }
    ];
